...
describe('index-test.js', () => {
	context('Working out Sample Standard deviation', () => {
		it('should calculate the correct number', () => expect(stdDev.sample([5, 5, 4, 2, 5])).to.equal('1.30'));
	...
	context('formatting', () => {
		...
		it('should preserve trailing zeros', () => expect(stdDev.format(1.50)).to.equal('1.50'));
	});
});
